...
MPMParticleSnow::MPMParticleSnow()
{

}

MPMParticleSnow::MPMParticleSnow(Vector2d pos, Vector2d vel, double mass, int num, double lambda, double mu, double harden, double COMPRESS, double STRETCH)
{
	position = pos;
	velocity = vel;
	this->mass = mass;
...
MPMParticleSnow::MPMParticleSnow(Vector2d pos, Vector2d vel, int num, SnowParameters p, Vector3d PColor)
{
	position = pos;
	velocity = vel;
	index = num;
...
void MPMParticleSnow::updatePos()
{
	position += DT*velocity;
}

void MPMParticleSnow::updateGradient()
{
...
void MPMParticleSnow::applyPlasticity()
{
...
Matrix2d MPMParticleSnow::energyDerivative()
{
...
void MPMParticleSnow::MPMUpdate()
{
	updatePos();
	updateGradient();
	applyPlasticity();
}
void MPMParticleSnow::DeltaForce()
{
