...
#include"Math.h"
MPMParticleSand::MPMParticleSand()
{
...
MPMParticleSand::MPMParticleSand(Vector2d pos, Vector2d vel, int num, SandParameters p,SandType Type, Vector3d PColor)
{
	position = pos;
	velocity = vel;
	this->mass = mass;
...
MPMParticleSand::MPMParticleSand(Vector2d pos, Vector2d vel, double mass, int num , double lambda, double mu )
{
	position = pos;
	velocity = vel;
	this->mass = mass;
...
void MPMParticleSand::MPMUpdate()
{
	updatePos();
	updateGradient();
	C_cp = C_cp0*(1 - coh);
...
void MPMParticleSand::updatePos()
{
	position += DT*velocity;
}

void MPMParticleSand::DeltaForce()
{

}

void MPMParticleSand::updateGradient()
{
...
Matrix2d MPMParticleSand::energyDerivative()
{
...
Matrix2d MPMParticleSand::Derivative(Matrix2d s)
{
...
void MPMParticleSand::applyPlasticity()
{
...
Matrix2d MPMParticleSand::project()
{
	Matrix2d s_ln = Matrix2d::Zero();
