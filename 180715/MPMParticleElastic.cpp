...
MPMParticleElastic::MPMParticleElastic()
{
}
MPMParticleElastic::~MPMParticleElastic()
{
...
MPMParticleElastic::MPMParticleElastic(Vector2d pos, Vector2d vel, double mass, int num, double lamda, double mu)
{
	position = pos;
	velocity = vel;
	this->mass = mass;
...
MPMParticleElastic::MPMParticleElastic(Vector2d pos, Vector2d vel, int num, ElasticParameters p, Vector3d PColor)
{
	position = pos;
	velocity = vel;
	index = num;
...
Matrix2d MPMParticleElastic::energyDerivative()
{
...
void MPMParticleElastic::MPMUpdate()
{
	updatePos();
	updateGradient();
	applyPlasticity();
}
void MPMParticleElastic::DeltaForce()
{
